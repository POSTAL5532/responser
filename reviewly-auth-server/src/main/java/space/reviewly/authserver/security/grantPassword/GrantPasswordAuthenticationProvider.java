...
public class GrantPasswordAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        GrantPasswordAuthenticationToken customPasswordAuthenticationToken = (GrantPasswordAuthenticationToken) authentication;
        ...
        if ((!user.getUsername().equals(username) && !user.getEmail().equals(username)) || !passwordEncoder.matches(password, user.getPassword())) {
            throw new OAuth2AuthenticationException(OAuth2ErrorCodes.ACCESS_DENIED);
        }
