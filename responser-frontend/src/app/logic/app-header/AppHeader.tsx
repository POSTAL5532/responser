                        ...
                        !!currentUser
                            ? <Button styleType={ButtonType.PRIMARY} onClick={() => navigateTo(USER_PROFILE_PAGE_URL)}>
                                <svg className="icon user" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M15.0034 16.25V14.75C15.0034 13.9544 14.6873 13.1913 14.1247 12.6287C13.5621 12.0661 12.7991 11.75 12.0034 11.75H6.00342C5.20777 11.75 4.44471 12.0661 3.8821 12.6287C3.31949 13.1913 3.00342 13.9544 3.00342 14.75V16.25" stroke="black" stroke-opacity="0.6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M8.99658 8.75C10.6534 8.75 11.9966 7.40685 11.9966 5.75C11.9966 4.09315 10.6534 2.75 8.99658 2.75C7.33973 2.75 5.99658 4.09315 5.99658 5.75C5.99658 7.40685 7.33973 8.75 8.99658 8.75Z" stroke="black" stroke-opacity="0.6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </Button>
                            : <Button styleType={ButtonType.PRIMARY} onClick={AuthorizationService.requestLoginPage}>
                                <svg className="icon login" xmlns="http://www.w3.org/2000/svg" width="11.49996" height="11.49995" viewBox="0 0 11.49996 11.49995" fill="none" version="1.1" id="svg8">
                                    <path d="m 7.5,0.5 h 2.33336 c 0.3094,0 0.6061,0.12291 0.8249,0.3417 0.2188,0.2188 0.3417,0.51554 0.3417,0.82496 v 8.16669 c 0,0.3094 -0.1229,0.6061 -0.3417,0.8249 -0.2188,0.2188 -0.5155,0.3417 -0.8249,0.3417 H 7.5" stroke="#000000" stroke-opacity="0.6" stroke-linecap="round" stroke-linejoin="round" id="path2"/>
                                    <path d="M 4.58398,8.66685 7.50065,5.75016 4.58398,2.83349" stroke="#000000" stroke-opacity="0.6" stroke-linecap="round" stroke-linejoin="round" id="path4"/>
