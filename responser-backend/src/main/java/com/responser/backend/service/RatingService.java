...
public class RatingService {
    ...
    public ResourceRating getResourceFullRatingById(String resourceId) {
        TypedQuery<ResourceRating> ratingQuery = entityManager.createQuery(
            "select new com.responser.backend.model.ResourceRating(r.resourceId, avg(r.rating), count(*)) from Review r where r.resourceId=:resourceId group by r.resourceId",
