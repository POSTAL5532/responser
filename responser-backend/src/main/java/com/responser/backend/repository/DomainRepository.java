...
public interface DomainRepository extends JpaRepository<Domain, String> {
    ...
    //   @Query("select avg(r.rating) from Review r join Domain d on r.resourceId=:domainId and r.resourceType='SITE'")
    ...
    //    @Query("select count(*) from Review r join Domain d on r.resourceId=d.id and d.id=:domainId and r.resourceType='SITE'")
