...
export class ContactFormService {
    ...
    getContactForms = async (pageable: Pagination): Promise<PageableResponse<ContactForm>> => {
        const response = await this.client.executeGetRequest(BASE_CONTACT_FROMS_URL, {params: {...pageable}})
